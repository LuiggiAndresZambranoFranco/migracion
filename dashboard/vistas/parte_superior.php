      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Paneles de edicion:</h6>
            <a class="collapse-item fas fa-fw fa-tachometer-alt" href="dashboard.php" >Dashboard</a>
            <a class="collapse-item" href="cards.php">carrera</a>
          </div>
        </div>
      </li>
